<script lang="ts">
	...
	async function handleSubmit() {
		...
		saving = true;
		try {
			const res = await fetch(`/admin/projects/${data.project.id}`, {
				method: 'PUT',
...
<div class="page">
	...
	>
		...
		<div class="form-group">
			<p class="field-label" id="project-stack-label">Tech Stack</p>
			<TagInput
				tags={stack}
		...
		<div class="form-group">
			<p class="field-label" id="project-features-label">Features</p>
			<TagInput
				tags={features}
		...
		<div class="form-group">
			<p class="field-label" id="project-screenshots-label">Screenshots</p>
			<ImageUpload
				images={screenshots}
