	...
	<form class="mt-6 space-y-4" onsubmit={handleSubmit}>
		<div>
			...
			<input
				...
				class="mt-1 w-full rounded border border-vsc-border bg-vsc-panel px-3 py-2 text-sm text-vsc-orange placeholder:text-vsc-text-muted/50 focus:border-vsc-blue focus:ring-1 focus:ring-vsc-blue/30 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed"
			/>
		</div>
		...
		<div class="pt-2">
			...
			<button
				type="submit"
				disabled={formState === 'submitting'}
				class="mt-3 flex items-center gap-2 rounded bg-vsc-blue px-5 py-2 text-sm font-medium text-white transition-colors hover:bg-vsc-blue/80 disabled:opacity-50 disabled:cursor-not-allowed"
			>
