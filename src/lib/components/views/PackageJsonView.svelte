...
<div class="max-w-3xl">
	...
	<div class="mt-4 rounded-lg border border-vsc-border bg-vsc-panel p-4">
		<p class="text-sm text-vsc-yellow">{'{'}</p>

		<div class="pl-4">
			<p class="text-sm">
				<span class="text-vsc-blue">"name"</span><span class="text-vsc-text">:</span>
				<span class="text-vsc-orange">"sushil-portfolio"</span><span class="text-vsc-text">,</span>
			</p>
			<p class="text-sm">
			...
			{#each data.skills as category, i}
				<div class="mt-3">
					<p class="text-sm">
						<span class="text-vsc-blue">"{category.title}"</span><span class="text-vsc-text">: {'{'}</span>
					</p>
					<div class="flex flex-wrap gap-2 py-2 pl-4">
						{#each category.skills as skill}
							<Badge text={skill} variant={variants[i % variants.length]} />
						{/each}
					</div>
