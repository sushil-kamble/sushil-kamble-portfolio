...
<div>
	<button
		...
		class="flex w-full items-center gap-1 rounded-sm px-2 py-0.5 text-left text-[13px] text-vsc-text-muted transition-colors hover:bg-vsc-panel/50 hover:text-vsc-text active:bg-vsc-panel"
